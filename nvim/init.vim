...
" required steps before usage:
"    a) make sure all previous nodejs versions are uninstalled
"    b) install nvm with lukechilds/zsh-nvm
"    c) nvm install node
"    d) sudo pacman -S yarn
"    e) npm install -g neovim
"    f) yarn global add neovim
"

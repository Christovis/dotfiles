...
export PATH="/home/chrbecker/anaconda3/bin:$PATH"

[ -f ~/.fzf.bash ] && source ~/.fzf.bash

# Terminal support of 256 colors
...
. /home/chrbecker/anaconda3/lib/python3.6/site-packages/powerline/bindings/bash/powerline.sh
